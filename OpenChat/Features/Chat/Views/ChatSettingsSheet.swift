...
struct ChatSettingsSheet: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .accessibilityIdentifier("chatSettings.form")
    ...
    private var stageSection: some View {
        Section(String(localized: "Stage")) {
            if viewModel.isStageEnabled {
                ...
                .accessibilityIdentifier("stage.directorModePicker")
                ...
                if viewModel.stageParticipants.isEmpty {
                    ...
                    ForEach(viewModel.stageParticipants) { participant in
                        HStack {
                            ...
                            .accessibilityIdentifier("stage.removeParticipant.\(participant.displayName)")
                        }
                    }
                }
                ...
                .accessibilityIdentifier("stage.addParticipantPicker")
            } else {
                Button {
                ...
                .accessibilityIdentifier("stage.enableButton")
            }
        }
    }
